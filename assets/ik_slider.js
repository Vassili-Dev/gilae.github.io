;(function ( $, window, document, undefined ) {
	...
	var pluginName = 'ik_slider',
		defaults = {
			'instructions': 'Use the right and left arrow keys to increase or decrease the slider value. Press end or home to set the slider to the max or min value respectively.',
			'minValue': 0,
			'maxValue': 100,
			'nowValue': 0,
			'step': 1
